        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Nestled in the lush Malnad region, Hillock Vista Homestay offers a perfect escape from the hustle and bustle of city life. Our property combines modern comfort with the natural beauty of the Western Ghats, providing an unforgettable experience for every guest.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Malnad Region</p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 text-blue-600 rounded-full mb-3">
                  <Award size={32} />
